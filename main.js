...
function init() {
    ...
    items.push(new ItemCompat(602, "Assassin II")
        .setCooldown(50)
        .setFunc((x, y, z, victim, user) => {

        }));

    items.push(new ItemCompat(601, "Apollon I").setDamage(4));
    items.push(new ItemCompat(602, "Apollon II")
        .setDamage(4)
        .setFunc((x, y, z, victim, user) => {

        }));

    items.push(new ItemCompat(600, "Barbarian I").setDamage(4));
    items.push(new ItemCompat(601, "Barbarian II")
        .setDamage(6)
        .setFunc((x, y, z, victim, user) => {

        }));

    items.push(new ItemCompat(602, "Stance I"));
    items.push(new ItemCompat(602, "Stance II"));

    items.push(new ItemCompat(602, "Fighter I"));
    items.push(new ItemCompat(602, "Fighter II")
        .setCooldown(45)
        .setFunc((x, y, z, victim, user) => {
            Entity.setVelY(victim, 10);
        }));

    items.push(new ItemCompat(602, "Phoenix I").setDamage(2)
        .setFunc((x, y, z, victim, user) => {

        }));
    items.push(new ItemCompat(602, "Phoenix II").setDamage(3)
        .setFunc((x, y, z, victim, user) => {
    ...
    items.push(new ItemCompat(602, "Fire Magicians I")
        .setCooldown(30)
        .setFunc((x, y, z, victim, user) => {

        }));
    items.push(new ItemCompat(602, "Fire Magicians II")
        .setCooldown(50)
        .setFunc((x, y, z, victim, user) => {

        }));

    items.push(new ItemCompat(602, "Ice Magicians I")
        .setCooldown(30)
        .setFunc((x, y, z, victim, user) => {

        }));
    items.push(new ItemCompat(602, "Ice Magicians II")
        .setCooldown(25)
        .setFunc((x, y, z, victim, user) => {

        }));

    items.push(new ItemCompat(602, "Riot Drinker I")
        .setCooldown(30)
        .setFunc((x, y, z, victim, user) => {

        }));
    items.push(new ItemCompat(602, "Riot Drinker II")
        .setCooldown(45)
        .setFunc((x, y, z, victim, user) => {
